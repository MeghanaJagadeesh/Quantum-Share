...
//	}
	...
	public ResponseEntity<String> emailVerify(String email) {
		QuantumShareUser user = userDao.findByEmail(email);
		if(user==null) {
			return new ResponseEntity<String>("new user", HttpStatus.OK);
		}else {
			return new ResponseEntity<String>("Account already exist with this email", HttpStatus.NOT_ACCEPTABLE);
		}
	}
